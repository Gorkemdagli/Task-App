...
| Faz | Konu                               | Durum                          |
| --- | ---------------------------------- | ------------------------------ |
| 0   | Proje Temeli ve Altyapı            | ✅ Tamamlandı (deploy atlandı) |
...
_Bu doküman `PROJECT.md`, `FRONTEND.md` ve `CLAUDE.md` ile birlikte yaşar. Roadmap'te bir faz değişirse (atlanır, sıralama değişir vb.) burası güncellenmeli._
